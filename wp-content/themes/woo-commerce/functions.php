...
function woo_commerce_setup() {
	...
	add_theme_support(
		'custom-background',
		apply_filters(
			'woo_commerce_custom_background_args',
			array(
...
add_action( 'after_setup_theme', 'woo_commerce_setup' );
 ...
 */
function woo_commerce_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'woo_commerce_content_width', 640 );
}
add_action( 'after_setup_theme', 'woo_commerce_content_width', 0 );
 ...
 */
function woo_commerce_widgets_init() {
	register_sidebar(
		array(
			'name'          => esc_html__( 'Sidebar', 'woo-commerce' ),
			'id'            => 'sidebar-1',
			'description'   => esc_html__( 'Add widgets here.', 'woo-commerce' ),
...
add_action( 'widgets_init', 'woo_commerce_widgets_init' );
